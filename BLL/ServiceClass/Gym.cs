...
{
    public class Gym : IArena, IObserver
    {
        ...
        {
            return _arenaDAL.GetGymCapacity();
        }

        public Tuple<TimeSpan, TimeSpan> GetOpenAndCloseTime()
        {
            return _arenaDAL.GetGymOpenCloseTime();
        }
        ...
        {
            return _arenaDAL.DeleteSlots(slotDate, 1);
        }

        public List<SlotModel> GetSlots(DateTime slotDate)
        {
            return _arenaDAL.GetSlotsForCustomer(slotDate, 1);
        }

        public List<SlotModel> GetUpcomingSlots()
        {
            return _arenaDAL.GetSlots(1);
        }

        public List<DateTime> GetDatesWithSlots()
        {
            return _arenaDAL.GetGymDatesWithSlots();
        }
        ...
        {
            _arenaDAL.UpdateSlotCapacity(bookingModel.BookingId,bookingModel.SlotId, 1);
        }
    }
